      ...
      while [not empty? queue] [
        ...
        if cur-node = des [
          ...
          while [cur-node != root] [
            ...
            ask link [who] of cur-node [who] of first travel  [set color yellow set thickness 0.3]
            wait delay
            display
          ]
          ...
          if not check? [
            ...
            if change-queue? = false [
              set queue lput self queue
               ask link [who] of cur-node [who] of self  [set color yellow - 3 set thickness 0.3]
              wait delay
              display
           ]
         ]
      ...
      while [not empty? queue] [
        ...
        if cur-node = des [
          ...
          while [cur-node != root] [
            ...
            set travel fput cur-node travel
            set cur-node [father-pointer] of cur-node
            ask link [who] of cur-node [who] of first travel  [set color green set thickness 0.3]
            wait delay
            display
          ]
          set travel fput root travel
        ...
        ask [link-neighbors] of cur-node[
          if not check? [
            ...
            if change-queue? = false [
              set queue lput self queue
              ask link [who] of cur-node [who] of self  [set color green - 3 set thickness 0.3]
              wait delay
              display
            ]
          ]
          ...
          if self = des-of-p [
            ...
            while [cur-node != root] [
              ask p[
                ...
                set travel fput cur-node travel
                set cur-node [father-pointer] of cur-node
                ask link [who] of cur-node [who] of first travel  [set color pink set thickness 0.3]
                wait delay
                display
              ]
            ]
          ...
          if self = des-of-p [
            ...
            while [cur-node != root] [
              ask p[
                ...
                set travel fput cur-node travel
                set cur-node [father-pointer] of cur-node
                ask link [who] of cur-node [who] of first travel  [set color cyan set thickness 0.3]
                wait delay
                display
              ]
            ]
