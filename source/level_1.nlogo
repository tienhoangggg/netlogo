...
to go
  if src != nobody [
    default-color
    if algorithm = "A*" [a* src]
    if algorithm = "GBFS" [gbfs src]
    if algorithm = "UCS" [ucs src]
    if algorithm = "BFS" [bfs src]
    if algorithm = "DFS" [dfs src]
    ask links [
...
to a* [#root]
  ...
  while [not empty? queue] [
    ...
    if cur-node = des [
      while [cur-node != #root] [
        ask link [who] of cur-node [who] of [father-pointer] of cur-node [set color yellow set thickness 0.3]
    ...
    ask [link-neighbors] of cur-node[
      if check? = false and ((cost > ([cost] of cur-node + [distance cur-node] of self)) or cost = -1) [
        ...
        set check? true
        ask link [who] of self [who] of [father-pointer] of self [set color yellow - 3 set thickness 0.3]
...
to gbfs [#root]
  ...
  while [not empty? queue] [
    ...
    if cur-node = des [
      while [cur-node != #root] [
        ask link [who] of cur-node [who] of [father-pointer] of cur-node  [set color orange set thickness 0.3]
        set cur-node [father-pointer] of cur-node
        wait delay
        display
      ]
...
to ucs [#root]
  ...
  while [not empty? queue] [
    ...
    if cur-node = des [
      while [cur-node != #root] [
        ask link [who] of cur-node [who] of [father-pointer] of cur-node [set color green set thickness 0.3]
        set cur-node [father-pointer] of cur-node
        wait delay
        display
      ]
    ...
    ask [link-neighbors] of cur-node[
      if check? = false and ((cost > ([cost] of cur-node + [distance cur-node] of self)) or cost = -1) [
        ...
        set father-pointer cur-node
        set check? true
        ask link [who] of self [who] of [father-pointer] of self [set color green - 3 set thickness 0.3]
        set queue lput self queue
        wait delay
        display
      ]
    ...
    ask [link-neighbors] of cur-node[
      ...
      if self = des [
        ...
        while [recursive-node != #root] [
          ask link [who] of recursive-node [who] of [father-pointer] of recursive-node  [set color pink set thickness 0.3]
  ...
  while [not empty? queue and finish? = false] [
    ...
    ask [link-neighbors] of cur-node[
      ...
      if self = des [
        let recursive-node self
        while [recursive-node != #root] [
          ask link [who] of recursive-node [who] of [father-pointer] of recursive-node  [set color cyan set thickness 0.3]
          set recursive-node [father-pointer] of recursive-node
          wait delay
          display
        ]
